...
emails.set('Ciri', 'cirilaOfCintra@hotmail.com')
emails.set('Yennefer', 'yenneferOfVengerberg@yahoo.com')
...
console.log(`O email de Triss esta cadastrado? ${emails.hasKey('Triss')}`)
console.log(`O email de Yennefer esta cadastrado? ${emails.hasKey('Yennefer')}`)
console.log(`Quantos email estão casdrados? ${emails.size()}`)
console.log(emails.key())
console.log(emails.values())
console.log(emails.keyValues())
console.log(emails.get('Yennefer'))
emails.remove('Geralt')
console.log(emails.key())
console.log(emails.values())
console.log(emails.keyValues())
console.log(emails.aurelio)
console.log(`Quantos email estão casdrados? ${emails.size()}`)
console.log(emails.String())
emails.forEach((c, v) => {
    console.log(`Chave ${c}: `, `chave original ${c}, valor ${v}`);
});
